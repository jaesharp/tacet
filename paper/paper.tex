...
Inconclusive rather than guessing, preventing false confidence under noise.
%
...
\begin{enumerate}
    \item \textbf{Calibrated verdicts}: We introduce a three-way decision framework
          ...
          insufficient, preventing false confidence under noisy conditions.
...
% - tacet's Inconclusive rate is the "price of honesty"
